...
func managementRegistration() managementRegistrationResponse {
	...
	return managementRegistrationResponse{
		Routes: []managementRoute{
			...
			{Method: http.MethodGet, Path: base + "/school/vouchers", Description: "School-season voucher + lottery-chance scan (CN only, activity window): read-only, feeds the panel voucher dialog."},
